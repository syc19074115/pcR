...
parser.add_argument('--save_path',default='./model/model18',help='save path of trained model')
parser.add_argument('--log_path',default='./runs/log/test18',help='save path of log')
